...
export default function StorybookGallery({
  ...
  return (
    <div
      className="relative pb-3 pr-3 sm:pb-4 sm:pr-4"
    ...
    >
      ...
      >
        ...
        <div
          ...
          className="
            pointer-events-none
            absolute bottom-7 left-0 top-7 z-30
            w-1.25
            rounded-r-full
            bg-linear-to-r
            from-pink-300/35
        ...
        <div
          ...
          className="
            pointer-events-none
            absolute bottom-9 left-1.5 top-9 z-30
            w-px
            bg-linear-to-b
            from-transparent
            via-[#c999b8]/30
        ...
        >
          <div aria-hidden="true" className="mb-4 flex items-center gap-3">
            ...
            <span className="text-[9px] text-pink-400/80 dark:text-fuchsia-300/60">
              ✦
            </span>
